  ...
  <div>
    <div v-if="container">
        ...
        <v-list dense class="nav-drawer-accordion pa-0">
          ...
          <v-list-group :value="false" dense :ripple="{ class: 'list-ripple' }">
            ...
            <v-list-item
              ...
              :input-value="
                currentMainComponent === 'ViewMetatypeRelationships'
              "
              :ripple="{ class: 'list-ripple' }"
            >
              <v-list-item-content>
                <v-list-item-title>{{
                  $t("relationshipTypes.relTypes")
                }}</v-list-item-title>
                <v-list-item-subtitle>{{
                  $t("relationshipTypes.description")
                }}</v-list-item-subtitle>
              </v-list-item-content>
            </v-list-item>
            ...
            <v-list-item
              ...
              link
              v-if="
                $auth.Auth('ontology', 'read', containerID) &&
                $store.getters.ontologyVersioningEnabled
              "
            ...
            >
              <v-list-item-content>
                <v-list-item-title>{{
                  $t("ontology.versioningTitle")
                }}</v-list-item-title>
                <v-list-item-subtitle>{{
                  $t("ontology.versioningSubtitle")
                }}</v-list-item-subtitle>
              </v-list-item-content>
            </v-list-item>
            ...
            >
              <v-list-item-content>
                <v-list-item-title>{{
                  $t("ontology.updateTitle")
                }}</v-list-item-title>
                <v-list-item-subtitle>{{
                  $t("ontology.updateDescription")
                }}</v-list-item-subtitle>
              </v-list-item-content>
            </v-list-item>
          </v-list-group>
          ...
          <v-list-group :value="false" dense :ripple="{ class: 'list-ripple' }">
            ...
            >
              <v-list-item-content>
                <v-list-item-title
                  >{{ $t("exports.graph") }}-<small>{{
                    $t("general.beta")
                  }}</small></v-list-item-title
                >
                <v-list-item-subtitle>{{
                  $t("exports.graphDescription")
                }}</v-list-item-subtitle>
              </v-list-item-content>
            </v-list-item>
            <v-list-item
            ...
            >
              <v-list-item-content>
                <v-list-item-title>{{
                  $t("modelExplorer.title")
                }}</v-list-item-title>
                <v-list-item-subtitle>{{
                  $t("modelExplorer.description")
                }}</v-list-item-subtitle>
              </v-list-item-content>
            </v-list-item>
          </v-list-group>
          ...
          >
            ...
            >
              <v-list-item-content>
                <v-list-item-title>{{
                  $t("users.containerTitle")
                }}</v-list-item-title>
                <v-list-item-subtitle>{{
                  $t("users.containerDescription")
                }}</v-list-item-subtitle>
              </v-list-item-content>
            </v-list-item>
            ...
            >
              <v-list-item-content>
                ...
                <v-list-item-subtitle>{{
                  $t("exports.containerDescription")
                }}</v-list-item-subtitle>
              </v-list-item-content>
            </v-list-item>
          ...
          >
            <template v-slot:activator>
              <v-list-item-title>{{
                $t("general.deepLynxAdministration")
              }}</v-list-item-title>
            </template>
          ...
          <v-list-group :value="false" :ripple="{ class: 'list-ripple' }">
            <template v-slot:activator>
              <v-list-item-title>{{
                $t("general.accessManagement")
              }}</v-list-item-title>
            </template>
            ...
            <v-card class="pa-3 signed-in-info elevation-0">
              ...
              <div>
                ...
                <span class="d-block sub-title"
                  >{{ container.name }}, #{{ container.id }}</span
                >
              </div>
            </v-card>
          </v-container>
          <v-container class="justify-end">
            <span class="d-block text-h6" style="margin-bottom: 10px"
              >{{ $t("help.foundBugs") }}
              <a :href="emailLink()">{{ $t("help.tellUs") }}</a>
            </span>
            <span class="d-block text-h6" style="margin-bottom: 10px"
              >{{ $t("help.needHelp") }}
              <a :href="helpLink()">{{ $t("general.wiki") }}</a>
            </span>
            <span class="d-block text-h6" style="margin-bottom: 10px"
      ...
      <v-main id="main-content-container">
        ...
        <v-container
          fluid
          v-if="currentMainComponent && currentMainComponent !== ''"
        >
            ...
            <component
              ...
              :class="{
                'main-content-component-constrained':
                  currentMainComponent !== 'ViewDataQuery',
        ...
        <v-container fluid v-else>
          ...
          <v-row v-if="$auth.IsAdmin() && stats !== null">
            ...
            <v-col
              ...
              :md="6"
              :lg="6"
              v-if="$auth.IsAdmin() && stats.statistics?.migrations"
            >
              <v-card class="d-flex flex-column height-full">
                <v-card-title
                  class="text-h3 ma-0 pb-1"
                  style="line-height: unset"
                  >{{ $t("statistics.migrations") }}</v-card-title
                >
                <v-card-text>
                  <v-col :cols="12"
                    ><json-viewer
                      :value="stats.statistics.migrations"
                    ></json-viewer
                  ></v-col>
                </v-card-text>
              </v-card>
            ...
            <v-col
              ...
              :md="6"
              :lg="6"
              v-if="$auth.IsAdmin() && stats.statistics"
            >
              <v-card class="d-flex flex-column height-full">
                <v-card-title
                  class="text-h3 ma-0 pb-1"
                  style="line-height: unset"
                  >{{ $t("statistics.recordCounts") }}</v-card-title
                >
                <v-card-text>
                  <v-list disabled>
            ...
            <v-col
              ...
              :md="6"
              :lg="6"
              v-if="$auth.IsAdmin() && stats.long_running_transactions"
            >
              <v-card class="d-flex flex-column height-full">
                <v-card-title
                  class="text-h3 ma-0 pb-1"
                  style="line-height: unset"
                  >{{ $t("statistics.longRunningTransactions") }}</v-card-title
                >
                <v-data-table
            ...
            <v-col
              ...
              :md="6"
              :lg="6"
              v-if="$auth.IsAdmin() && stats.mean_execution_time"
            >
              <v-card class="d-flex flex-column height-full">
                <v-card-title
                  class="text-h3 ma-0 pb-1"
                  style="line-height: unset"
                  >{{ $t("statistics.meanExecutionTime") }}</v-card-title
                >
                <v-data-table
            ...
            <v-col cols="12" :md="6" :lg="6">
              <v-card class="d-flex flex-column height-full">
                <v-card-title
                  class="text-h3 ma-0 pb-1"
                  style="line-height: unset"
                  >{{ $t("general.welcome") }}</v-card-title
                >
                <v-card-text>
                  <p>{{ $t("help.welcomeCard") }}</p>
                  <p>
                    <a :href="welcomeLink">{{ $t("general.wiki") }}</a>
                  </p>
                </v-card-text>
              </v-card>
            </v-col>
            ...
            <v-col cols="12" :md="6" :lg="6">
              <v-card class="d-flex flex-column height-full">
                <v-card-title
                  class="text-h3 ma-0 pb-1"
                  style="line-height: unset"
                  >{{ $t("ontology.ontology") }}</v-card-title
                >
                ...
                <template v-if="!ontologyPopulated">
                  ...
                  <v-card-text>
                    ...
                    <p>
                      <a :href="ontologyLink">{{ $t("ontology.loading") }}</a>
                    </p>
                  </v-card-text>
                </template>
                ...
                <template v-else>
                  <v-card-text class="mt-4">
                    <v-row>
                      <v-col :cols="6" class="text-center">
                        <p class="text-h2 ma-2" style="line-height: unset">
                          {{ metatypesCount }}
                        </p>
                        <h3 class="text-h3" style="line-height: unset">
                          {{ $t("classes.classes") }}
                        </h3>
                      </v-col>
                      <v-col :cols="6" class="text-center">
                  ...
                  <v-card-actions
                    class="d-flex flex-grow-1 pa-4 justify-center align-end"
                  >
                    <v-btn
                      color="primary"
                      @click="currentMainComponent = 'Metatypes'"
                    >
                      {{ $t("ontology.manage") }}
                    </v-btn>
                  </v-card-actions>
            ...
            <v-col cols="12" :md="6" :lg="6">
              <v-card class="d-flex flex-column height-full">
                <v-card-title
                  class="text-h3 ma-0 pb-1"
                  style="line-height: unset"
                  >{{ $t("dataSources.dataSources") }}</v-card-title
                >
                <v-card-text v-if="dataSources.length <= 0">{{
                  $t("help.dataSourceCard")
                }}</v-card-text>
                <v-card-text v-else>
                  <v-carousel
                    :cycle="true"
                  ...
                  >
                    ...
                    >
                      <p class="text-h4">
                        {{ dataSource.name }} {{ $t("events.dataImported") }}
                      </p>
                ...
                >
                  <v-btn
                    color="primary"
                    @click="currentMainComponent = 'ViewDataSources'"
                  >
                    {{ $t("dataSources.description") }}
                  </v-btn>
                </v-card-actions>
            ...
            <v-col cols="12" :md="6" :lg="6">
              <v-card class="d-flex flex-column height-full">
                <v-card-title
                  class="text-h3 ma-0 pb-1"
                  style="line-height: unset"
                  >{{ $t("containers.inviteUsers") }}</v-card-title
                >
                ...
                >
                  <v-btn
                    color="primary"
                    @click="currentMainComponent = 'ViewContainerUsers'"
                  >
                    {{ $t("users.manage") }}
                  </v-btn>
                </v-card-actions>
...
export default Vue.extend({
  ...
  methods: {
    transactionHeaders() {
      return [
        ...
        {
          text: this.$t("statistics.duration"),
    ...
    meanExecHeaders() {
      return [
        ...
        { text: this.$t("query.query"), value: "query" },
        {
          text: this.$t("statistics.meanExecutionTime"),
    ...
    setActiveComponent(menuIndex: string) {
      ...
      switch (menuIndex) {
        ...
        case "metatype-relationships": {
          ...
          this.$router.replace(
            `/containers/${this.containerID}/metatype-relationships`
          );
          break;
        }
        ...
        case "data-sources": {
          ...
          this.$router.replace(
            `/containers/${this.containerID}/data-sources/${this.arguments}`
          );
          break;
        }
        ...
        case "data-imports": {
          ...
          this.$router.replace(
            `/containers/${this.containerID}/data-imports/${this.arguments}`
          );
          break;
        }
        ...
        case "container-users": {
          ...
          this.$router.replace(
            `/containers/${this.containerID}/container-users`
          );
          break;
        }
        ...
        case "ontology-update": {
          ...
          this.$router.replace(
            `/containers/${this.containerID}/ontology-update`
          );
          break;
        }
        ...
        case "ontology-versioning": {
          ...
          this.$router.replace(
            `/containers/${this.containerID}/ontology-versioning`
          );
          break;
        }
        ...
        case "container-export": {
          ...
          this.$router.replace(
            `/containers/${this.containerID}/container-export`
          );
          break;
        }
  ...
  mounted() {
    ...
    this.$client
      .retrieveContainer(this.containerID!)
      .then((container) => {
    ...
    this.$client
      .listMetatypes(this.containerID as string, {
        count: true,
    ...
    this.$client
      .listMetatypeRelationshipPairs(this.containerID as string, {
        count: true,
        ontologyVersion: this.$store.getters.currentOntologyVersionID,
      })
    ...
    this.$client
      .listDataSources(this.containerID as string)
      .then((dataSources) => {
        this.dataSources = dataSources;

        this.dataSources.forEach((source, i) => {
          this.$client
            .countDataForSource(this.containerID as string, source.id as string)
            .then((count) => {
