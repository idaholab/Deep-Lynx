...
export class Client {
  ...
  submitGraphQLQuery(
    ...
    if (options?.rawMetadataEnabled)
      queryParams.rawMetadataEnabled = options.rawMetadataEnabled;

    return this.postRawReturn<any>(
      `/containers/${containerID}/data`,
      query,
      queryParams
    );
  }

  submitNodeGraphQLQuery(
    containerID: string,
    nodeID: string,
    query: any
  ): Promise<any> {
  ...
  // metatypes etc.
  async containerFromImport(
    container: ContainerT | any,
    owlFile: File | null,
    owlFilePath: string
  ): Promise<string> {
    ...
    formData.append(
      ...
      container.config.data_versioning_enabled
    );
    formData.append(
      "ontology_versioning_enabled",
      container.config.ontology_versioning_enabled
    );
    formData.append(
      "enabled_data_sources",
      container.config.enabled_data_sources.join(",")
    );
    ...
    return axios
      .post(
        buildURL(this.config?.rootURL!, { path: `containers/import` }),
        formData,
        config
      )
          ...
          if (error.response.data.error.error) {
            if (error.response.data.error.error.detail) {
              ...
              if (dlError.includes("already exists")) {
                resp.data.error =
                  "This container name is already taken, please choose another.";
              } else {
  ...
  async updateContainerFromImport(
    containerID: string,
    owlFile: File | null,
    owlFilePath: string,
    name?: string
    ...
    const resp: AxiosResponse = await axios.put(
      buildURL(this.config?.rootURL!, {
        path: `containers/import/${containerID}`,
      }),
      formData,
      config
    );
  ...
  listMetatypes(
    ...
    return this.get<MetatypeT[] | number>(
      `/containers/${containerID}/metatypes`,
      query
    );
  }
  ...
  listMetatypeRelationshipPairs(
    ...
    return this.get<MetatypeRelationshipPairT[] | number>(
  ...
  createMetatype(
    ...
    return this.post<MetatypeT[]>(`/containers/${containerID}/metatypes`, {
      name,
      description,
  ...
  retrieveMetatype(
    ...
    return this.get<MetatypeT>(
      `/containers/${containerID}/metatypes/${metatypeID}`
    );
  }

  retrieveMetatypeByUUID(
    containerID: string,
    metatypeID: string
  ): Promise<MetatypeT> {
    return this.get<MetatypeT>(
  ...
  listMetatypeKeys(
    ...
    metatypeID: string,
    deleted = false
  ): Promise<MetatypeKeyT[]> {
    const query: { [key: string]: any } = {};
    query.deleted = deleted;

    return this.get<MetatypeKeyT[]>(
      `/containers/${containerID}/metatypes/${metatypeID}/keys`,
      query
    );
  }
  ...
  deleteMetatypeKey(
    ...
    return this.delete(
      `/containers/${containerID}/metatypes/${metatypeID}/keys/${keyID}`,
      query
    );
  }
  ...
  generateKeyPairForServiceUser(
    containerID: string,
    serviceUserID: string,
    note?: string
  ): Promise<KeyPairT> {
    return this.post<KeyPairT>(
      `/containers/${containerID}/service-users/${serviceUserID}/keys`,
      { note }
    );
  }

  deleteKeyPairForServiceUser(
    containerID: string,
    serviceUserID: string,
    keyID: string
  ): Promise<boolean> {
  ...
  createServiceUser(
    containerID: string,
    payload: CreateServiceUserPayloadT
  ): Promise<UserT> {
    return this.post<UserT>(
      `/containers/${containerID}/service-users`,
      payload
    );
  }
  ...
  getServiceUsersPermissions(
    containerID: string,
    userID: string
  ): Promise<ServiceUserPermissionSetT> {
    return new Promise((resolve, reject) => {
      this.getRaw<string[][]>(
        `/containers/${containerID}/service-users/${userID}/permissions`
      )
        .then((results) => {
  ...
  setServiceUsersPermissions(
    containerID: string,
    userID: string,
    set: ServiceUserPermissionSetT
  ): Promise<boolean> {
    return this.put<boolean>(
      `/containers/${containerID}/service-users/${userID}/permissions`,
      set
  ...
  listMetatypeRelationships(
    ...
    return this.get<MetatypeRelationshipT[] | number>(
      `/containers/${containerID}/metatype_relationships`,
      query
    );
  }
  ...
  ): Promise<MetatypeRelationshipT> {
    return this.get<MetatypeRelationshipT>(
  ...
  createMetatypeRelationship(
    ...
    return this.post<MetatypeRelationshipT[]>(
      `/containers/${containerID}/metatype_relationships`,
      { name, description, ontology_version: ontologyVersion }
    );
  }
  ...
  ): Promise<MetatypeRelationshipPairT> {
    return this.get<MetatypeRelationshipPairT>(
      `/containers/${containerID}/metatype_relationship_pairs/${metatypeRelationshipPairID}`
    );
  }

  listMetatypeRelationshipPairsForMetatype(
    containerID: string,
    metatypeID: string,
    deleted = false
  ): Promise<MetatypeRelationshipPairT[]> {
  ...
  createMetatypeRelationshipPair(
    containerID: string,
    metatypeRelationshipPair: any
  ): Promise<MetatypeRelationshipPairT[]> {
    return this.post<MetatypeRelationshipPairT[]>(
      `/containers/${containerID}/metatype_relationship_pairs`,
  ...
  listMetatypeRelationshipKeys(
    ...
    deleted = false
  ): Promise<MetatypeRelationshipKeyT[]> {
    const query: { [key: string]: any } = {};
    query.deleted = deleted;

    return this.get<MetatypeRelationshipKeyT[]>(
      `/containers/${containerID}/metatype_relationships/${relationshipID}/keys`,
      query
    );
  }
  ...
  deleteMetatypeRelationshipKey(
    ...
    return this.delete(
      `/containers/${containerID}/metatype_relationships/${metatypeRelationshipID}/keys/${keyID}`,
      query
    );
  }
  ...
  createMetatypeRelationshipKey(
    containerID: string,
    metatypeRelationshipID: string,
    key: MetatypeRelationshipKeyT
  ): Promise<MetatypeRelationshipKeyT[]> {
    return this.post<MetatypeRelationshipKeyT[]>(
  ...
  createDataSource(containerID: string, dataSource: any): Promise<DataSourceT> {
    return this.post<DataSourceT>(
      `/containers/${containerID}/import/datasources`,
      dataSource
    );
  }
  ...
  updateDataSource(
    ...
    return this.put<DataSourceT>(
      `/containers/${containerID}/import/datasources/${dataSource.id}`,
      dataSource
    );
  }
  ...
  upgradeTypeMappings(
    containerID: string,
    dataSourceID: string,
    payload: TypeMappingUpgradePayloadT
  ): Promise<ResultT<boolean>[]> {
    return this.postRawReturn<ResultT<boolean>[]>(
      `/containers/${containerID}/import/datasources/${dataSourceID}/mappings/upgrade`,
      payload
    );
  }

  dataSourceJSONFileImport(
    containerID: string,
    dataSourceID: string,
    file: File,
    fastload?: boolean
    ...
    return this.postFile(
      `/containers/${containerID}/import/datasources/${dataSourceID}/imports`,
      "import",
      file,
      { fastLoad: fastload }
    );
  ...
  saveDataSourceTemplates(
    containerID: string,
    templates: any[]
  ): Promise<boolean> {
    return this.post(
      `/containers/${containerID}/data_source_templates`,
      templates
    );
  }
  ...
  listDataSources(
    ...
    return this.get<DataSourceT[]>(
      `/containers/${containerID}/import/datasources`,
      { archived, sortBy: "archived", timeseries }
    );
  }
  ...
  retrieveDataSource(
    ...
    // we hardcoded the sortBy to insure we're always getting archived data sources at the bottom of the list
    return this.get<DataSourceT>(
      `/containers/${containerID}/import/datasources/${dataSourceID}`
    );
  }
  ...
  deleteDataSources(
    ...
    dataSourceID: string,
    {
      ...
      forceDelete,
      withData,
    }: { archive?: boolean; forceDelete?: boolean; withData?: boolean }
  ): Promise<boolean> {
    const query: { [key: string]: any } = {};
  ...
  activateDataSource(
    ...
    return this.postNoPayload(
      `/containers/${containerID}/import/datasources/${dataSourceID}/active`
    );
  }
  ...
  reprocessDataSource(
    ...
    return this.postNoPayload(
      `/containers/${containerID}/import/datasources/${dataSourceID}/reprocess`
    );
  }

  reprocessImport(containerID: string, importID: string): Promise<boolean> {
    return this.postNoPayload(
      `/containers/${containerID}/import/imports/${importID}/reprocess`
    );
  }
  ...
  listEventActionStatusForEventAction(
    actionID: string
  ): Promise<EventActionStatusT[]> {
    return this.get<EventActionStatusT[]>(
      `/event_actions/${actionID}/event_action_status`
    );
  }

  updateEventActionStatus(status: EventActionT): Promise<EventActionStatusT> {
    return this.put<EventActionStatusT>(
      `/event_action_status/${status.id}`,
      status
    );
  }
  ...
  listEventActionStatuses(archived = false): Promise<EventActionStatusT[]> {
    // we hardcoded the sortBy to insure we're always getting archived data sources at the bottom of the list
    return this.get<EventActionStatusT[]>(`/event_action_status`, {
      archived,
      sortBy: "archived",
    });
  }
  ...
  downloadTimeseriesData(containerID: string, dataSourceID: string) {
    return this.get(
      `/containers/${containerID}/import/datasources/${dataSourceID}/download`
    );
  }

  retrieveTimeseriesRowCount(
    containerID: string,
    dataSourceID: string
  ): Promise<TimeseriesRowCount> {
    return this.get<TimeseriesRowCount>(
      `/containers/${containerID}/import/datasources/${dataSourceID}/timeseries/count`
    );
  }

  retrieveTimeseriesRange(
    containerID: string,
    dataSourceID: string
  ): Promise<TimeseriesRange> {
    return this.get<TimeseriesRange>(
      `/containers/${containerID}/import/datasources/${dataSourceID}/timeseries/range`
    );
  }
  ...
  retrieveNodeHistory(containerID: string, nodeID: string): Promise<NodeT[]> {
    ...
    return this.get<NodeT[]>(
      `/containers/${containerID}/graphs/nodes/${nodeID}`,
      query
    );
  }
  ...
  retrieveEdgeHistory(containerID: string, edgeID: string): Promise<EdgeT[]> {
    ...
    return this.get<EdgeT[]>(
      `/containers/${containerID}/graphs/edges/${edgeID}`,
      query
    );
  }
  ...
  listImportData(
    ...
    importID: string,
    {
      ...
      sortBy,
      sortDesc,
    }: { limit: number; offset: number; sortBy?: string; sortDesc?: boolean }
  ): Promise<ImportDataT[]> {
    const query: { [key: string]: any } = {};
  ...
  listOntologyVersions(
    containerID: string,
    { status, createdBy }: { status?: string | string[]; createdBy?: string }
  ): Promise<OntologyVersionT[]> {
    const query: { [key: string]: any } = {};
    ...
    return this.get<OntologyVersionT[]>(
      `/containers/${containerID}/ontology/versions`,
      query
    );
  }
  ...
  assignRoleToUser(
    containerID: string,
    payload: AssignRolePayloadT
  ): Promise<boolean> {
    return this.post<boolean>(
      `/containers/${containerID}/users/roles`,
      payload
    );
  }
  ...
  retrieveUserRoles(containerID: string, userID: string): Promise<string[]> {
    return this.get<string[]>(
      `/containers/${containerID}/users/${userID}/roles`
    );
  }
  ...
  retrieveTypeMapping(
    ...
    return this.get<TypeMappingT>(
      `/containers/${containerID}/import/datasources/${dataSourceID}/mappings/${typeMappingID}`
    );
  }

  retrieveTypeMappingByShapeHash(
    containerID: string,
    dataSourceID: string,
    shapeHash: string
  ): Promise<TypeMappingT> {
    ...
    return this.get<TypeMappingT>(
      `/containers/${containerID}/import/datasources/${dataSourceID}/mappings`,
      query
    );
  }
  ...
  updateTypeMapping(
    ...
    dataSourceID: string,
    typeMappingID: string,
    mapping: TypeMappingT
  ): Promise<boolean> {
    return this.putNoData(
      `/containers/${containerID}/import/datasources/${dataSourceID}/mappings/${typeMappingID}`,
      mapping
    );
  }
  ...
  exportTypeMappings(
    ...
    return this.postRawReturn<ResultT<any>[]>(
      `/containers/${containerID}/import/datasources/${dataSourceID}/mappings/export`,
      {
  ...
  importTypeMappings(
    ...
    return this.postFileRawReturn<ResultT<any>[]>(
      `/containers/${containerID}/import/datasources/${dataSourceID}/mappings/import`,
      "mappings",
      file
    );
  }

  retrieveTransformations(
    containerID: string,
    dataSourceID: string,
    typeMappingID: string
  ): Promise<TypeMappingTransformationT[]> {
    return this.get<TypeMappingTransformationT[]>(
      `/containers/${containerID}/import/datasources/${dataSourceID}/mappings/${typeMappingID}/transformations`
    );
  }

  retrieveTransformation(
    containerID: string,
    transformationID: string
  ): Promise<TypeMappingTransformationT> {
    return this.get<TypeMappingTransformationT>(
      `/containers/${containerID}/transformations/${transformationID}`
    );
  }
  ...
  listTypeMappings(
    ...
    if (sortBy) query.sortBy = sortBy;
    if (sortDesc) query.sortDesc = sortDesc;
    if (resultingMetatypeName)
      query.resultingMetatypeName = resultingMetatypeName;
    if (resultingMetatypeRelationshipName)
      query.resultingMetatypeRelationshipName =
        resultingMetatypeRelationshipName;
  ...
  listExports(
    ...
    return this.get<ExportT[] | number>(
      `/containers/${containerID}/data/export`,
      query
    );
  }

  createExport(containerID: string, exportT: ExportT): Promise<ExportT> {
    return this.post<ExportT>(
      `/containers/${containerID}/data/export/`,
      exportT
    );
  }
  ...
  startExport(
    ...
    return this.post<boolean>(
      `/containers/${containerID}/data/export/${exportID}`,
      {},
      { reset }
    );
  }
  ...
  createOntologyVersion(
    containerID: string,
    version: OntologyVersionT,
    baseVersionID: string
  ): Promise<ChangelistT> {
    const query: { [key: string]: any } = {};
    query.baseOntologyVersion = baseVersionID;

    return this.post<ChangelistT>(
      `/containers/${containerID}/ontology/versions/`,
      version,
      query
    );
  ...
  approveOntologyVersion(
    containerID: string,
    versionID: string
  ): Promise<ChangelistApprovalT> {
    return this.put<ChangelistApprovalT>(
      `/containers/${containerID}/ontology/versions/${versionID}/approve`,
      {}
    );
  }

  sendOntologyVersionForApproval(
    containerID: string,
    versionID: string
  ): Promise<ChangelistApprovalT> {
    return this.post<ChangelistApprovalT>(
      `/containers/${containerID}/ontology/versions/${versionID}/approve`,
      {}
    );
  }

  revokeOntologyVersionApproval(
    containerID: string,
    versionID: string
  ): Promise<boolean> {
    return this.delete(
  ...
  applyOntologyVersion(
    ...
    return this.post<boolean>(
      `/containers/${containerID}/ontology/versions/${versionID}/publish`,
      {}
    );
  }
  ...
  deleteOntologyVersion(
    ...
    return this.delete(
      `/containers/${containerID}/ontology/versions/${versionID}`
    );
  }
  ...
  updateWebGLFiles(
    ...
    return this.putFiles(
      `/containers/${containerID}/graphs/webgl/files/${fileID}`,
      files
    );
  }
  ...
  deleteServalSession(containerID: string, sessionID: string): Promise<any> {
    return this.delete(
      `/containers/${containerID}/serval/sessions/${sessionID}`
    );
  }

  listServalObjects(containerID: string, sessionID: string): Promise<any> {
    return this.get(
      `/containers/${containerID}/serval/sessions/${sessionID}/objects`
    );
  }
  ...
  getServalObject(
    ...
    return this.get(
      `/containers/${containerID}/serval/sessions/${sessionID}/objects/${objectID}`
    );
  }
  ...
  listServalPlayers(containerID: string, sessionID: string): Promise<any> {
    return this.get(
      `/containers/${containerID}/serval/sessions/${sessionID}/players`
    );
  }
  ...
  deleteServalPlayer(
    ...
    return this.delete(
      `/containers/${containerID}/serval/sessions/${sessionID}/players/${playerID}`
    );
  }
  ...
  private async get<T>(
    ...
    if (queryParams) {
      url = buildURL(this.config?.rootURL!, {
        path: uri,
  ...
  private async deleteWithResponse(
    uri: string,
    queryParams?: { [key: string]: any }
  ): Promise<boolean> {
    const config: AxiosRequestConfig = {};
  ...
  private async postNoPayload(uri: string): Promise<boolean> {
    ...
    const resp: AxiosResponse = await axios.post(
      buildURL(this.config?.rootURL!, { path: uri }),
      {},
      config
    );
  ...
  private async postFileRawReturn<T>(
    uri: string,
    inputName: string,
    file: File
  ): Promise<T> {
