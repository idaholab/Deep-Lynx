var unityFramework = (() => {
  ...
  return function (unityFramework) {
    ...
    function _SendCadNodeDataToReact(response) {
      window.dispatchReactUnityEvent(
        "SendCadNodeDataToReact",
        UTF8ToString(response)
      );
    }
    function _SendJsonObjectsToReact(response) {
      window.dispatchReactUnityEvent(
        "SendJsonObjectsToReact",
        UTF8ToString(response)
      );
    }
    function _SendSelectedBoolToReact(response) {
      window.dispatchReactUnityEvent(
        "SendSelectedBoolToReact",
        UTF8ToString(response)
      );
    }
    ...
    var asmLibraryArg = {
      ...
      SendCadNodeDataToReact: _SendCadNodeDataToReact,
      SendJsonObjectsToReact: _SendJsonObjectsToReact,
      SendSelectedBoolToReact: _SendSelectedBoolToReact,
    ...
    var dynCall_jiiijii = (Module["dynCall_jiiijii"] = function () {
      return (dynCall_jiiijii = Module["dynCall_jiiijii"] =
        Module["asm"]["dynCall_jiiijii"]).apply(null, arguments);
    });
    ...
    var dynCall_iijjijii = (Module["dynCall_iijjijii"] = function () {
      return (dynCall_iijjijii = Module["dynCall_iijjijii"] =
        Module["asm"]["dynCall_iijjijii"]).apply(null, arguments);
    });
    ...
    var dynCall_jiijii = (Module["dynCall_jiijii"] = function () {
      return (dynCall_jiijii = Module["dynCall_jiijii"] =
        Module["asm"]["dynCall_jiijii"]).apply(null, arguments);
    });
    ...
    var dynCall_viififfii = (Module["dynCall_viififfii"] = function () {
      return (dynCall_viififfii = Module["dynCall_viififfii"] =
        Module["asm"]["dynCall_viififfii"]).apply(null, arguments);
    });
