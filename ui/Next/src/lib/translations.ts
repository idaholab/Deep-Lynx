export const translations = {
  en: {
    ...
    help: {
      ...
      regex:
        "Enter a valid regular expression for matching against future value",
      releaseNode:
    ...
    modelExplorer: {
      instructions: {
        ...
        upload:
          "Upload a file to DeepLynx, and transform it into an interactive model.",
        select:
          "Select a file attached to a node in DeepLynx, and transform it into an interactive model.",
      },
