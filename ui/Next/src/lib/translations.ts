export default {
    en: {
        ...
        help: {
            ...
            classEdgeParam:
                "Choose the Class that the parent or child record belongs to.",
            classSearch:
                "Select the Class this data transformation will result in",
            columnNameRegex:
            ...
            conditions:
                "Your transformation will only be applied to the data when these conditions are met.",
            customTemplateFields:
                "Use this section to specify any additional information your adapter may need from the user in order to function properly- things like userame and password, or project ID. More information can be found on the wiki.",
            tellUs: "Tell Us!",
            dataRetention:
            ...
            dateFormatStringSmall:
                "Format Help - assumes UTC time if no timezone given.",
            dataSourceCard:
            ...
            dataSourceEdgeParam:
                "Choose the Data Source the parent or child record belongs to.",
            deprecatedParams:
            ...
            edgeInfo:
                "View edge information: Left click edge (hover to see relationship type & edge ID)",
            enumOptions:
            ...
            exportDataSource:
                "Selects all non-archived data sources to be exported to your container file.",
            exportDestination:
                "The type of database or data source your data will be exported to",
            exportEndpoint:
                "The HTTP/S endpoint of your Gremlin enabled destination.",
            exportOntology:
                "Selects the entire ontology to be exported to your container file.",
            exportPassword:
                "User's password or access key as specified by your destination",
            exportPath: "Optional path to include after the root endpoint.",
            exportPort:
                "Port on which to contact the Gremlin enabled destination.",
            exportProtocol:
            ...
            exportTypeMapping:
                "Selects all type mappings in the container to be exported to your container file.",
            exportUsername:
                "Gremlin username or username as specified by your destination",
            exportWrites:
            ...
            graphColor:
                "Node color is automatically set based on class name or data source.",
            graphHighlight:
                "Highlight node/edge and related nodes/edges: Hover over node or edge",
            graphHover:
                'Hover over the blue "+" icon in the top left of the graph view to find graph edit tools!',
            graphLabels:
                'Node labels show the "name" property (if present) or else the node ID.',
            ...
            importDataSource:
                "Imports new or updated data sources from the supplied container file.",
            importOntology:
                "Imports a new ontology from the supplied container file.",
            importTemplates:
            ...
            importTypeMapping:
                "Imports new or updated type mappings from the supplied container file.",
            ...
            nodeInfo:
                "View node information: Left click node (hover to see class & node ID)",
            ontologyVersioning:
            ...
            queryDocs:
                "Need help writing your query? Consult the detailed documentation",
            querySample:
            ...
            relationshipSearch:
                "Select the Relationship this data transformation will result in",
            rootArray:
                "Selecting a root array means this transformation will be applied for every object contained in the selected root array.",
            samplePayload:
                "This is an example of the data this transformation will be applied to.",
            selectChangelist:
            ...
            createdAtManual:
                'Select "Default" to use the import time as the "created at" value, or set the time manually',
            removedForSecurity: "(Removed for Security)",
            tagMapping:
                "Nodes or edges may be associated with tags. Tags connect graph data with 2D/3D models.",
            mergeHelp:
        ...
        errors: {
            ...
            nameError:
                "A container with this name has already been created by the current user.",
            checkLogs: "Please see the logs for additional detail.",
            owlError:
                "Please select either an ontology file or valid URL to an ontology (.owl) file",
            loadOntology:
            ...
            endDate:
                "Please enter an end date that is greater than the start date",
            ...
            importMappings:
                "Errors importing type mappings: check type mapping file or logs for more information",
            deleteMappings:
            ...
            graphQL:
                "There is a problem with the GraphQL query or server error. Please see the result tab.",
            matrix: "Results Length Varies, Cannot Show Correlation Matrix",
            noValidRelationships:
                "No valid relationships for this metatype pair.",
        },
        warnings: {
            deleteContainer:
            ...
            graphqlComments:
                "Please remove all comments before submitting the query",
            deleteServiceUser:
            ...
            rootClass:
                "Please note that this will create a root class with no parent class.",
            deleteTemplate:
        ...
        containers: {
            ...
            adminAlert:
                "Only Container Administrators can dismiss alerts. Please contact your administrator to remove this alert.",
            ...
            acceptDescription:
                "By clicking the button below you are accepting an invitation to be a part of the container ",
            loginToAccept: "Login to Accept Invitation",
            acceptSuccess: "Invitation Accepted Successfully",
            chooseNow:
                "You may now choose this container from the container selection screen",
        ...
        ontology: {
            ...
            rollbackDescription:
                "Rollback to this Ontology Version (creates changelist for further approval)",
        ...
        classes: {
            ...
            selectParentHelp:
                "Select a class to be the parent or leave blank for a root class",
        ...
        dataSources: {
            ...
            customName: "Custom",
            customDescription:
                'Custom data sources use Data Source Templates as their config object. Choose an existing template from the container, or select "New Template" to create a new one.',
        },
        dataSourceTemplates: {
        ...
        timeseries: {
            ...
            nodeExplanation:
                "Each entry in this table represents a different structure of timeseries data attached to the node",
            ...
            limitHint:
                "Provide a limit. 0 will return the default of up to 10k records.",
        ...
        imports: {
            ...
            containerDescription:
                "Use this page to import your container and its various parts from a file that was generated by a previous container export.",
        ...
        query: {
            ...
            new: "New Query",
            includeRaw:
                "Include Unprocessed Data Staging Records in Query (may impact performance)",
            ...
            includeHistoricalRaw:
                "Include Historical Records in Search (may impact performance)",
        ...
        apiKeys: {
            ...
            success:
                "WRITE DOWN YOUR SECRET - this is the only time you will be able to see it.",
            userKey:
        ...
        events: {
            ...
            confirmSend:
                "Are you sure you would like to send this Event Action?",
    ...
    es: {
        ...
        home: {
            ...
            metatypeRelationshipsDescription:
                "Modificar relaciones entre clases",
            metatypeRelationshipPairs: "Pares de clase / relación",
            metatypeRelationshipPairsDescription:
                "Modificar pares de clase / relación",
            import: "Importar",
            data: "Data",
            ...
            dataMappingDescription:
                "Manejar asignaciones entre clases y datos.",
            dataExport: "Exportar",
