...
ALTER TABLE default_edge_partition ADD CONSTRAINT default_node_partition_unique_constraint_edges UNIQUE(container_id,relationship_pair_id,data_source_id,created_at, origin_id, destination_id);
