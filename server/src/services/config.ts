...
export class Config {
    ...
    public toString(): string {
        return `
        Config {
            root_address: ${this._root_address},
            email_address: ${this._email_address},
            email_enabled: ${this._email_enabled},
            is_node: ${this._is_node},
            email_validation_enforced: ${this._email_validation_enforced},
            container_invite_url: ${this._container_invite_url},
            template_dir: ${this._template_dir},
            asset_dir: ${this._asset_dir},
            web_gui_dir: ${this._web_gui_dir},
            web_gl_viewer_dir: ${this._web_gl_viewer_dir},
            vue_app_id: ${this._vue_app_id},
            is_windows: ${this._is_windows},
            cache_provider: ${this._cache_provider},
            cache_default_ttl: ${this._cache_default_ttl},
            cache_redis_connection_string: ${this._cache_redis_connection_string},
            initial_import_cache_ttl: ${this._initial_import_cache_ttl},
            core_db_connection_string: ${this._core_db_connection_string},
            timescaledb_enabled: ${this._timescaledb_enabled},
            session_secret: ${this._session_secret},
            encryption_key_path: ${this._encryption_key_path},
            encryption_public_key_path: ${this._encryption_public_key_path},
            file_storage_method: ${this._file_storage_method},
            filesystem_storage_directory: ${this._filesystem_storage_directory},
            azure_blob_connection_string: ${this._azure_blob_connection_string},
            azure_blob_container_name: ${this._azure_blob_container_name},
            vue_app_name: ${this._vue_app_name},
            server_port: ${this._server_port},
            log_level: ${this._log_level},
            max_request_body_size: ${this._max_request_body_size},
            basic_user: ${this._basic_user},
            basic_password: ${this._basic_password},
            auth_strategy: ${this._auth_strategy},
            initial_superuser: ${this._initial_superuser},
            superuser_email: ${this._superuser_email},
            superuser_password: ${this._superuser_password},
            saml_enabled: ${this._saml_enabled},
            saml_adfs_entry_point: ${this._saml_adfs_entry_point},
            saml_adfs_issuer: ${this._saml_adfs_issuer},
            saml_adfs_callback: ${this._saml_adfs_callback},
            saml_adfs_claims_name: ${this._saml_adfs_claims_name},
            saml_adfs_claims_email: ${this._saml_adfs_claims_email},
            saml_adfs_private_cert_path: ${this._saml_adfs_private_cert_path},
            saml_adfs_public_cert_path: ${this._saml_adfs_public_cert_path},
            saml_adfs_signature_algorithm: ${this._saml_adfs_signature_algorithm},
            saml_adfs_audience: ${this._saml_adfs_audience},
            saml_adfs_disable_requested_authn_context: ${this._saml_adfs_disable_requested_authn_context},
            saml_adfs_want_authn_response_signed: ${this._saml_adfs_want_authn_response_signed},
            saml_adfs_want_assertions_signed: ${this._saml_adfs_want_assertions_signed},
            auth_config_file: ${this._auth_config_file},
            max_import_retries: ${this._max_import_retries},
            export_data_interval: ${this._export_data_interval},
            export_data_concurrency: ${this._export_data_concurrency},
            data_source_receive_buffer: ${this._data_source_receive_buffer},
            queue_system: ${this._queue_system},
            smtp_username: ${this._smtp_username},
            smtp_password: ${this._smtp_password},
            smtp_host: ${this._smtp_host},
            smtp_port: ${this._smtp_port},
            smtp_tls: ${this._smtp_tls},
            smtp_client_id: ${this._smtp_client_id},
            smtp_client_secret: ${this._smtp_client_secret},
            smtp_refresh_token: ${this._smtp_refresh_token},
            smtp_access_token: ${this._smtp_access_token},
            rsa_url: ${this._rsa_url},
            rsa_client_key: ${this._rsa_client_key},
            rsa_client_id: ${this._rsa_client_id},
            hpc_email: ${this._hpc_email},
            serval_url: ${this._serval_url},
            emit_events: ${this._emit_events},
            log_jobs: ${this._log_jobs},
            rabbitmq_url: ${this._rabbitmq_url},
            azure_service_bus_connection_string: ${this._azure_service_bus_connection_string},
            limit_default: ${this._limit_default},
            minio_endpoint: ${this._minio_endpoint},
            minio_port: ${this._minio_port},
            minio_ssl: ${this._minio_ssl},
            minio_access_key: ${this._minio_access_key},
            minio_secret_key: ${this._minio_secret_key},
            minio_bucket_name: ${this._minio_bucket_name},
            cors_origins: ${Array.isArray(this._cors_origins) ? this._cors_origins.join(', ') : this._cors_origins}
        }
        `;
    }
}
