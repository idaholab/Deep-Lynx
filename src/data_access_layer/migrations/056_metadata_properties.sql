ALTER TABLE nodes ADD COLUMN IF NOT EXISTS metadata_properties jsonb;
ALTER TABLE edges ADD COLUMN IF NOT EXISTS metadata_properties jsonb;

DROP VIEW IF EXISTS current_nodes;
CREATE VIEW current_nodes
AS
