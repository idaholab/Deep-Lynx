...
*/
export default class EdgeStorage extends Mapper{
...
DO
    ...
    private static updateStatement(e: EdgeT): QueryConfig[] {
        return [{
            text: `UPDATE edges SET container_id = $1, relationship_pair_id = $2, graph_id = $3, origin_node_id = $4, destination_node_id = $5, properties = $6, original_data_id = $7, data_source_id = $8, type_mapping_transformation_id = $9, origin_node_original_id = $10, destination_node_original_id = $11, import_data_id = $13, data_staging_id = $14, composite_original_id = $15, origin_node_composite_original_id = $16, destination_node_composite_original_id = $17 WHERE id = $12`,
            values: [e.container_id, e.relationship_pair_id,e.graph_id, e.origin_node_id, e.destination_node_id,  e.properties, e.original_data_id, e.data_source_id, e.type_mapping_transformation_id, e.origin_node_original_id, e.destination_node_original_id, e.id, e.import_data_id, e.data_staging_id, e.composite_original_id, e.origin_node_composite_original_id, e.destination_node_composite_original_id]
        }]
    }

    private static updateByCompositeOriginalIDStatement(e: EdgeT): QueryConfig[] {
        return [{
            text: `UPDATE edges SET container_id = $1, relationship_pair_id = $2, graph_id = $3, origin_node_id = $4, destination_node_id = $5, properties = $6, original_data_id = $7, data_source_id = $8, type_mapping_transformation_id = $9, origin_node_original_id = $10, destination_node_original_id = $11, import_data_id = $14, data_staging_id = $15, composite_original_id = $16, origin_node_original_id = $17, destination_node_original_id = $18 WHERE composite_original_id = $16 AND data_source_id = $13`,
