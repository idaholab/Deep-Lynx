...
import MetatypeKeyMapper from "../mappers/metatype_key_mapper";
...
export default class MetatypeKeyRepository extends  Repository implements RepositoryInterface<MetatypeKey> {
    ...
    async save(user: UserT, k: MetatypeKey): Promise<Result<boolean>> {
    ...
    async bulkSave(user: UserT, k: MetatypeKey[]): Promise<Result<boolean>> {
