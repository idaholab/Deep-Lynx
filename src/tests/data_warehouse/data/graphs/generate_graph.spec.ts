...
describe('A Complex Graph can be created', async () => {
    ...
    it('can be created', async () => {
        ...
        const pair2 = await rpStorage.Create(
            'test suite',
            new MetatypeRelationshipPair({
                name: faker.random.alphaNumeric(),
                description: faker.random.alphaNumeric(),
        ...
        // EDGE SETUP
        const edge1 = await storage.CreateOrUpdateByCompositeID(
            'test suite',
            new Edge({
                container_id: containerID,
                graph_id: graph.value.id!,
        ...
        const edge2 = await storage.CreateOrUpdateByCompositeID(
            'test suite',
            new Edge({
                container_id: containerID,
                graph_id: graph.value.id!,
        ...
        const edge3 = await storage.CreateOrUpdateByCompositeID(
            'test suite',
            new Edge({
                container_id: containerID,
                graph_id: graph.value.id!,
        ...
        const edge4 = await storage.CreateOrUpdateByCompositeID(
            'test suite',
            new Edge({
                container_id: containerID,
                graph_id: graph.value.id!,
        ...
        const edge5 = await storage.CreateOrUpdateByCompositeID(
            'test suite',
            new Edge({
                container_id: containerID,
                graph_id: graph.value.id!,
        ...
        const edge6 = await storage.CreateOrUpdateByCompositeID(
            'test suite',
            new Edge({
                container_id: containerID,
                graph_id: graph.value.id!,
        ...
        const edge7 = await storage.CreateOrUpdateByCompositeID(
            'test suite',
            new Edge({
                container_id: containerID,
                graph_id: graph.value.id!,
        ...
        const edge8 = await storage.CreateOrUpdateByCompositeID(
            'test suite',
            new Edge({
                container_id: containerID,
                graph_id: graph.value.id!,
