defmodule Datum.DataOrigin.OriginRepo.Migrations.SearchTables do
  ...
  def change do
    execute "CREATE VIRTUAL TABLE data_search USING fts5(id,path,original_path,description,file_type,natural_language_properties,properties,tags,domains, tokenize='porter ascii', content='data', content_rowid='rowid');"
