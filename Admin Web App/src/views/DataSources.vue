  ...
  <div>
    ...
    >
      ...
      <template v-slot:[`item.actions`]="{ item }">
        <delete-data-source-dialog v-if="!item.archived" :containerID="item.container_id" :dataSource="item" icon="both"></delete-data-source-dialog>
        <delete-data-source-dialog v-else :containerID="item.container_id" :dataSource="item" icon="trash"></delete-data-source-dialog>
      </template>
    </v-data-table>
  </div>
</template>
