export default {
  en: {
    ...
    exports: {
      ...
      warningStopBody: "Deep Lynx will attempt to stop this currently processing export. However, this action is not instant and you may see some records exported even after you've stopped the process. Give the action 5-10 minutes to fully stop before either contacting support or attempting to stop the process again.",
      ok: "Ok",
      warningResetTitle: "Reset Export",
      warningResetBody: "This will completely reset this export, meaning that all data currently in the container will be re-queued up for export. This DOES NOT ERASE ANY DATA THAT MIGHT HAVE ALREADY BEEN EXPORTED. Please insure that your export destination is empty prior to restarting the export.",
      cancel : "Cancel",
      understandReset: "I Understand, Reset Export",
      warningDeleteTitle: "Delete Export",
      warningDeleteBody: "Deleting an Export WILL NOT DELETE ANY DATA ON EXPORT TARGET. Insure that your destination also removes any data that might have been exported before this export request is deleted. This will also have no affect on current data stored in this container",
